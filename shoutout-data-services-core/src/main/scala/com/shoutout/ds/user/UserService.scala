  ...
  def apply(s3Service : S3Service)(implicit ec : ExecutionContext) = new UserService with DatabaseSupport with Logging {
    ...
    private def insertWelcomeRow(user : ShoutoutUser, deviceInfo : DeviceInfo)(implicit session : Session) = {
      shoutoutDao.insertShoutouts(user :: Nil, Shoutout(None,
        ...
        user.id.get,
        "",
        "https://s3.amazonaws.com/shoutout-prod-system/firstimage_1.jpg",
        false,
        None,
        Dates.nowDT,
        false,
      ...
      shoutoutDao.insertShoutouts(user :: Nil, Shoutout(None,
        ...
        user.id.get,
        "",
        "https://s3.amazonaws.com/shoutout-prod-system/firstimage_2.jpg",
        false,
        None,
        Dates.nowDT,
        false,
      ...
      shoutoutDao.insertShoutouts(user :: Nil, Shoutout(None,
        ...
        user.id.get,
        "",
        "https://s3.amazonaws.com/shoutout-prod-system/firstimage_3.jpg",
        false,
        None,
        Dates.nowDT,
        false,
