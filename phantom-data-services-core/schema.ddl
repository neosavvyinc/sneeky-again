create table `USERS` (`ID` BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,`UUID` VARCHAR(254) NOT NULL,`EMAIL` VARCHAR(256) NOT NULL,`PASSWORD` VARCHAR(300) NOT NULL,`BIRTHDAY` DATE NOT NULL,`ACTIVE` BOOLEAN NOT NULL,`PHONE_NUMBER` VARCHAR(254) NOT NULL,`STATUS` VARCHAR(254) NOT NULL)
...
create table `SESSIONS` (`SESSIONID` VARCHAR(254) NOT NULL,`USERID` BIGINT NOT NULL,`CREATED` TIMESTAMP NOT NULL,`LASTACCESSED` TIMESTAMP NOT NULL,`APPLE_PUSH_ID` VARCHAR(254))
