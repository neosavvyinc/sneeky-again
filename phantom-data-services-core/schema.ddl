...
use phantom;
create table USERS (ID BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,UUID VARCHAR(254) NOT NULL,EMAIL VARCHAR(256),PASSWORD VARCHAR(300),BIRTHDAY DATE,ACTIVE BOOLEAN NOT NULL,PHONE_NUMBER VARCHAR(254),SOUND_NOTIF BOOLEAN NOT NULL,NEW_PICTURE_NOTIF BOOLEAN NOT NULL,INVITATION_COUNT INTEGER NOT NULL,STATUS VARCHAR(254) NOT NULL);
