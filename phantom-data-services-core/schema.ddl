...
create table CONVERSATIONS (id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,TO_USER BIGINT NOT NULL,FROM_USER BIGINT NOT NULL,RECV_PHONE_NUMBER VARCHAR(254) NOT NULL,LAST_UPDATE_DATE TIMESTAMP NOT NULL);
create table CONVERSATION_ITEMS (id BIGINT NOT NULL AUTO_INCREMENT PRIMARY KEY,CONVERSATION_ID BIGINT NOT NULL,IMAGE_URL VARCHAR(254) NOT NULL,IMAGE_TEXT VARCHAR(254) NOT NULL,TO_USER BIGINT NOT NULL,FROM_USER BIGINT NOT NULL,IS_VIEWED BOOLEAN DEFAULT false NOT NULL,CREATED_DATE TIMESTAMP NOT NULL,TO_USER_DELETE BOOLEAN DEFAULT false NOT NULL,FROM_USER_DELETE BOOLEAN DEFAULT false NOT NULL);
